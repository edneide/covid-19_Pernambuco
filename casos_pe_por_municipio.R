setwd("~/Google Drive/Coronavirus/IRRD/planilhas de pe/18-05-2020/")
...
# Salvando em csv
write.csv(casos_srag, "covid_19_PE_SRAG_att_em_19_05_2020.csv")
write.csv(obitos_pe, "covid_19_PE_obitos_att_em_19_05_2020.csv")
